...
//        b.traverse();
        ...
        while ((lineReview = brReview.readLine()) != null && reviewcount < reviewLengthToParse) {
            ...
            if (business != null && !uniqueBusinessNames.contains(business.getName())) {
                ...
                r1.setBusiness_id(business.getBusiness_id());
...
//            System.out.println("Business ID: " + review.getBusiness_id());
//            System.out.println("Name: " + review.getBusiness_name());
//            System.out.println("Review Text: " + review.getReview_text());
            String fileName = review.getBusiness_id() + ".ser";
